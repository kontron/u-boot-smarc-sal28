/*
 * Date & Time support for Microcrystal RV-8803-C7.
 *
 * based on rv8803.c which is
...
#define RTC_CTL_BIT_RST		0x01	/* reset */
#define RTC_FLAG_BIT_V2F    0x02
#define RTC_FLAG_BIT_V1F    0x01
